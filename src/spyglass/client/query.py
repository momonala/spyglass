...
class SpyglassQueryClient:
    ...
    def __init__(
        ...
        self._base = _normalize_host(host)
    ...
    def fetch_metrics(
        ...
        *,
        ...
        resp = self._session.get(f"{self._base}/metrics", params=params, timeout=self._timeout)
        resp.raise_for_status()
        return resp.json()
    ...
    def fetch_logs(
        ...
        *,
        ...
        resp = self._session.get(f"{self._base}/logs", params=params, timeout=self._timeout)
        resp.raise_for_status()
        return resp.json()
